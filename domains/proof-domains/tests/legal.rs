//! Legal domain journey (document vertical). Domain DATA only.
...
pub fn journey() -> BuiltProof {
    ...
    let e1 = create_event(
        proof_core::model::EventContent {
            v: 1,
            event_type: EventType::new("legal.document.drafted"),
            subject: "matter:m7".into(),
    ...
    let e2 = create_event(
        proof_core::model::EventContent {
            v: 1,
            event_type: EventType::new("legal.document.signed"),
            subject: "matter:m7".into(),
    ...
    let mut b = proof_verify::ProofBuilder::new(
        Proposition {
            v: 1,
            kind: "legal.document.executed".into(),
            subject: e1.id.clone(),
